    ...
    <section class="calout">
      <div class="container">
            ...
            <div align="center">
                ...
                <a href="visitorspage.php" class="btn btn-primary" target="_blank">Visitors</a>
            </div><br />
...
//==================================== Function for add the status
/*  function checkss(){
    var roomNumberChange = $('#roomMembers').val();

    $.ajax({
      url:"scripts/keypageScript.php",
      method:"POST",
      data:{roomNumberChange:roomNumberChange},
      dataType:"json",
      success:function(data){
        $('#stat').text(data.statussd);
        $('#status_timein').text(data.checkinTime);
        $('#status_timeout').text(data.checkoutTime);
      }
    });
  }
*/
