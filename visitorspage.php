                ...
                <div class="card-body">
                  ...
                  <fieldset>
                      <form class="needs-validation" novalidate action="<?php $_PHP_SELF ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <!--  <div class="col-md-6 mb-3"> 
                            <label for="friendName" class="textcol"> Status</label>
                            <input type="text" class="form-control" id="friendName" value="Checked in" name="friendName" placeholder="eg. 0245816854" required disabled>
                            <div class="invalid-feedback">
                            Please provide the Friends name.
                            </div>
                          </div>-->
                        ...
                        <div align="center">
                            ...
                            <!--<button class="btn btn-danger" type="submit" name="CheckoutregisterBtn" id="checkoutregisterBtn" value="check out">Check out</button>-->
                        </div>
                ...
                <div class="card-body">
                  ...
                  <div align="center">
                       ...
                       <div class="col-md-6 mb-3"> 
                        ...
                        <a href="viewVisitors.php" target="_blank">Click to view Visitors Log</a>
                  </div>
                </div>
              </div>
            </div>
